...
## Fork Changes (developmaso/claude-code-action@main)
...
- **Updated Base Action**: Uses `developmaso/claude-code-base-action@main` which includes OAuth credential handling
